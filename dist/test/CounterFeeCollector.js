...
let counter;
let deployer;
describe("CounterFeeCollector (sync fee with fee collector)", () => __awaiter(void 0, void 0, void 0, function* () {
    beforeEach("tests", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            counterAddress = (yield hardhat_1.deployments.get("CounterFeeCollector")).address;
            counter = (yield hardhat_1.ethers.getContractAt("CounterFeeCollector", counterAddress));
        });
    });
