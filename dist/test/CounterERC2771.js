...
let deployer;
let deployerAddress;
describe("CounterERC2771 (sponsored call from trusted forwarder with sender)", () => __awaiter(void 0, void 0, void 0, function* () {
    beforeEach("tests", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            counterAddress = (yield hardhat_1.deployments.get("CounterERC2771")).address;
            counter = (yield hardhat_1.ethers.getContractAt("CounterERC2771", counterAddress));
    ...
    it("Should increment count (1Balance)", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, relay_1.sponsoredCallERC2771Local)(request, null, "");
