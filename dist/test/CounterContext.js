...
let feeTokenAddress;
let feeToken;
describe("CounterContext (sync fee with fee collector, fee token, fee)", () => __awaiter(void 0, void 0, void 0, function* () {
    beforeEach("tests", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            counterAddress = (yield hardhat_1.deployments.get("CounterContext")).address;
            counter = (yield hardhat_1.ethers.getContractAt("CounterContext", counterAddress));
    ...
    it("Should increment count (ETH)", () => __awaiter(void 0, void 0, void 0, function* () {
        (0, chai_1.expect)(yield counter.count()).to.equal(0);
